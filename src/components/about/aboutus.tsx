         ...
         <section className="relative py-20 px-6 border-b border-white/5 overflow-hidden">
            ...
            <div className="container mx-auto max-w-4xl text-center relative z-10">
               <div className="inline-flex items-center gap-2 mb-6 px-3 py-1 rounded-full border border-white/10 bg-white/5 backdrop-blur-md">
                  ...
                  <span className="text-[10px] uppercase tracking-[0.2em] text-zinc-400 font-bold">System Architects</span>
               </div>
         ...
         <section className="relative py-24 px-6 bg-[#080808]">
            <div className="container mx-auto max-w-3xl">
               ...
               <div className="text-center mb-16">
                  <h2 className="text-3xl font-medium tracking-tighter mb-4">System Origin</h2>
                  <p className="text-zinc-500">From diagnosing the problem to engineering the solution.</p>
               </div>
               ...
               <div className="relative border-l border-white/10 ml-4 md:ml-0 md:pl-12 space-y-16">
                  ...
                  <div className="relative pl-8 md:pl-0">
                     ...
                     <div className="flex flex-col md:flex-row gap-6">
                        <div className="md:w-32 shrink-0">
                           <div className="text-sm font-mono text-red-500 font-bold">DIAGNOSIS</div>
                           <div className="text-xs text-zinc-600 uppercase tracking-wider">The Problem</div>
                        </div>
                        <div>
                           <div className="flex items-center gap-3 mb-3">
                              <div className="p-2 bg-white/5 rounded-md"><Lightbulb className="w-4 h-4 text-white" /></div>
                              <h3 className="text-xl font-medium text-white">Clinics Are Leaking Revenue</h3>
                           </div>
                           <p className="text-zinc-400 leading-relaxed text-sm md:text-base">
                              We noticed brilliant doctors struggling not because of their skills, but because their operational "flow" was broken. Phones went unanswered, leads vanished, and old patients were forgotten.
                           </p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="relative pl-8 md:pl-0">
                     ...
                     <div className="flex flex-col md:flex-row gap-6">
                        <div className="md:w-32 shrink-0">
                           <div className="text-sm font-mono text-zinc-500 font-bold">ENGINEERING</div>
                           <div className="text-xs text-zinc-600 uppercase tracking-wider">The Fix</div>
                        </div>
                        <div>
                           <div className="flex items-center gap-3 mb-3">
                              <div className="p-2 bg-white/5 rounded-md"><History className="w-4 h-4 text-white" /></div>
                              <h3 className="text-xl font-medium text-white">Replacing Chaos with Infrastructure</h3>
                           </div>
                           <p className="text-zinc-400 leading-relaxed text-sm md:text-base">
                              We stopped acting like a marketing agency and started thinking like engineers. We treated a clinic like a machine—identifying leaks, plugging them with automation, and installing a controlled intake engine.
                           </p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="relative pl-8 md:pl-0">
                     ...
                     <div className="flex flex-col md:flex-row gap-6">
                        <div className="md:w-32 shrink-0">
                           <div className="text-sm font-mono text-white font-bold">DEPLOYMENT</div>
                           <div className="text-xs text-zinc-600 uppercase tracking-wider">Current State</div>
                        </div>
                        <div>
                           <div className="flex items-center gap-3 mb-3">
               ...
               <div className="grid md:grid-cols-2 gap-px bg-white/10 border border-white/10">
                  ...
                  <div className="bg-[#050505] p-10 hover:bg-[#0A0A0A] transition-colors group">
                     ...
                     <p className="text-zinc-400 text-sm leading-relaxed">
                        To remove the volatility from running a clinic. We aim to make patient acquisition as boring and predictable as paying the electric bill.
                     </p>
                  </div>
                  ...
                  <div className="bg-[#050505] p-10 hover:bg-[#0A0A0A] transition-colors group">
                     ...
                     <p className="text-zinc-400 text-sm leading-relaxed">
                        A world where doctors can focus 100% on treatment, knowing their clinic's infrastructure is handling the business of growth 24/7.
                     </p>
                  </div>
