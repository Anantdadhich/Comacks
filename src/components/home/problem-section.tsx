...
export function ProblemSection() {
  return (
    <section className="relative bg-[#050505] text-white py-24 md:py-32 overflow-hidden">
      {/* Background Texture (Noise) - Matches Design System */}
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            Without performance intelligence, these 4 leaks quietly drain your clinic's profitability every single month.
          </motion.p>
        </div>
        ...
        >
          {REVENUE_LEAKS.map((leak) => (
            <motion.div
              ...
              className="group relative flex flex-col justify-between h-full p-8 rounded-3xl border border-white/5 bg-gradient-to-b from-white/[0.03] to-transparent hover:from-white/[0.05] hover:to-white/[0.01] transition-all duration-500 overflow-hidden"
            >
              ...
              <div className="flex-1">
                <div className="flex items-start justify-between mb-8">
                  ...
                  <span className="text-[10px] font-bold tracking-wider uppercase text-zinc-300 bg-white/5 px-3 py-1.5 rounded-full border border-white/10 backdrop-blur-sm group-hover:bg-red-500/10 group-hover:text-red-400 group-hover:border-red-500/10 transition-colors duration-300">
                    {leak.highlight}
                  </span>
                </div>
